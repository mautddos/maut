...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("TECH_VJ_BOT_TOKEN", "7744686284:AAH7VAxpZSNdTMLf7VKS6agHCFdkHZMb98w")
    TECH_VJ_BOT_USERNAME = os.environ.get("TECH_VJ_BOT_USERNAME", "Urlmautbot") # Bot username without @.
